export default function MidSection() {
    ...
    const logOp = [
        ...
        {
            svg: <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" role="img" aria-hidden="true" class="crayons-icon crayons-icon--default">
    ...
    return (
        ...
        <div className="w-full gap-2 flex items-center pt-6 flex-wrap flex-col  ">

            {
                logOp.map((op, i) => {
                    return (
                        <article key={`Article - ${i}`} className="w-[90%] border-2  hover:bg-gray-50 p-4 rounded flex sm:w-[60%] max-w-xl cursor-pointer ">
                            {op.svg}
                            <span className="w-full flex justify-center" >{op.text}</span>
